...
* Turn your project into a GitHub repository:
  ...
  * After `git` has initialized locally, run the following commands:
    * `git remote add origin git@github.com:tohuynh/siglatools.git`
    * `git push -u origin master`
* Register siglatools with Codecov:
  * Make an account on [codecov.io](https://codecov.io) (Recommended to sign in with GitHub)
  * Select `tohuynh` and click: `Add new repository`
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/tohuynh/siglatools/settings/secrets),
...
* Generate and add an access token as a secret to the repository for auto documentation generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/tohuynh/siglatools/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with more tests and deploy
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/tohuynh/siglatools/settings/branches), click `Add rule` and select the
